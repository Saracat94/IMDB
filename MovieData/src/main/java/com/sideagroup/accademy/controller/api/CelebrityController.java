...
import com.sideagroup.accademy.dto.*;
...
public class CelebrityController {
    ...
    @Operation(summary = "Retrieves all celebrities without movies",
            description = "Retrieves all celebrities without movie in paginated way")
    ...
    @Operation(summary = "Gets a celebrity with movie by id",
            description = "Returns a celebrity with movie as per id")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Successfully retrieved"),
            @ApiResponse(responseCode = "404", description = "Not found - The celebrity was not found",
                    content = @Content(schema = @Schema(implementation = DefaultErrorDto.class)))})
    @GetMapping("{id}")
    ...
    @Operation(summary = "Creates a new celebrity",
            description = "Creates a new celebrity")
    @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Successfully created"),
            @ApiResponse(responseCode = "400", description = "A celebrity with same id already exists",
                    content = @Content(schema = @Schema(implementation = DefaultErrorDto.class)))})
    @PostMapping
    ...
    @Operation(summary = "Updates a new celebrity",
            description = "Updates the celebrity with the given id")
    ...
    @Operation(summary = "Deletes a celebrity",
            description = "Deletes the celebrity with the given id")
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Successfully deleted")
    })
    @DeleteMapping("{id}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public void deleteById(@PathVariable String id) { celebrityService.deleteById(id); }
